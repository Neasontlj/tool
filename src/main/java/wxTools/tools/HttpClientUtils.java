...
//		}
    ...
    public static String ajaxPostJson(String url, Map<String, String> dataMap, String jsonString) {
...
//		}
    ...
    public static String ulucuPostJson(String url,String authorization, Map<String,String> dataMap) {
        String charset = "UTF-8";
        HttpPost httpPost = new HttpPost(url);
        ...
        if (dataMap != null) {
            ...
            try {
                formEntity = new UrlEncodedFormEntity(nvps, charset);
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
            formEntity.setContentEncoding(charset);
